...
class CloneTask(Base):
    ...
    selected_link_template_group_id = Column(Integer, nullable=True)
    selected_contact_template_group_id = Column(Integer, nullable=True)
...
class SupportBot(Base):
    ...
    welcome_text_type = Column(String, default="plain")
