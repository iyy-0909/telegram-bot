...
def sync_clone_task_to_listener_tasks(clone_task):
    ...
    try:
        ...
        task = ListenerTask(
            ...
            selected_link_template_group_id=getattr(clone_task, "selected_link_template_group_id", None),
            selected_contact_template_group_id=getattr(clone_task, "selected_contact_template_group_id", None),
